...
# CRITICAL: Add logo FIRST before any other sidebar content
add_sidebar_logo()
...
# ============================================================================
# HEADER SECTION - Clean Professional Design (Pure HTML)
# ============================================================================
...
with col1:
    ...
    ">
        ...
        <div style="font-size: 12px; color: #6b7280; font-weight: 500; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 0.5rem;">
            TOTAL REVENUE
        </div>
        <div style="font-size: 32px; font-weight: 700; color: #1a1a1a; margin-bottom: 0.5rem;">
            {format_currency(current_revenue)}
        </div>
        <div style="font-size: 13px; color: {'#10b981' if revenue_change >= 0 else '#ef4444'};">
            <span style="font-weight: 600;">{'↗' if revenue_change >= 0 else '↘'} {abs(revenue_change):.1f}%</span>
            <span style="color: #9ca3af; margin-left: 0.25rem;">vs. {format_currency(previous_revenue if not previous_df.empty else 0)} last month</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
with col2:
    ...
    ">
        ...
        <div style="font-size: 13px; color: {'#10b981' if orders_change >= 0 else '#ef4444'};">
            <span style="font-weight: 600;">{'↗' if orders_change >= 0 else '↘'} {abs(orders_change):.1f}%</span>
            <span style="color: #9ca3af; margin-left: 0.25rem;">vs. {format_number(previous_orders if not previous_df.empty else 0)} last month</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
with col3:
    ...
    ">
        ...
        <div style="font-size: 32px; font-weight: 700; color: #1a1a1a; margin-bottom: 0.5rem;">
            {format_currency(current_avg_order)}
        </div>
        <div style="font-size: 13px; color: {'#10b981' if avg_order_change >= 0 else '#ef4444'};">
            <span style="font-weight: 600;">{'↗' if avg_order_change >= 0 else '↘'} {abs(avg_order_change):.1f}%</span>
            <span style="color: #9ca3af; margin-left: 0.25rem;">vs. {format_currency(previous_avg_order if not previous_df.empty else 0)} last month</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
with col4:
    ...
    ">
        ...
        <div style="font-size: 32px; font-weight: 700; color: #1a1a1a; margin-bottom: 0.5rem;">
            {(current_customers / current_orders * 100) if current_orders > 0 else 0:.1f}%
        </div>
        <div style="font-size: 13px; color: {'#10b981' if customers_change >= 0 else '#ef4444'};">
            <span style="font-weight: 600;">{'↗' if customers_change >= 0 else '↘'} {abs(customers_change):.1f}%</span>
            <span style="color: #9ca3af; margin-left: 0.25rem;">vs. {format_number(previous_customers if not previous_df.empty else 0)} last month</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
# ============================================================================
# TEAM INFORMATION - Updated Names
# ============================================================================
...
with team_col1:
    ...
    ">
        ...
        <h4 style="margin: 0; color: #0f172a; font-size: 18px; font-weight: 600;">Het Patel</h4>
        <p style="font-size: 13px; color: #475569; margin: 0.5rem 0 0 0;">Data Cleaning & EDA</p>
    </div>
    """, unsafe_allow_html=True)
...
with team_col2:
    ...
    ">
        <div style="font-size: 48px; margin-bottom: 0.75rem;">👥</div>
        <h4 style="margin: 0; color: #0f172a; font-size: 18px; font-weight: 600;">Ved Zala</h4>
        <p style="font-size: 13px; color: #475569; margin: 0.5rem 0 0 0;">Customer Analytics</p>
    </div>
    """, unsafe_allow_html=True)
...
with team_col3:
    ...
    ">
        <div style="font-size: 48px; margin-bottom: 0.75rem;">🔮</div>
        <h4 style="margin: 0; color: #0f172a; font-size: 18px; font-weight: 600;">Parth Shah</h4>
        <p style="font-size: 13px; color: #475569; margin: 0.5rem 0 0 0;">Demand Forecasting</p>
    </div>
    """, unsafe_allow_html=True)
...
with team_col4:
    ...
    ">
        <div style="font-size: 48px; margin-bottom: 0.75rem;">🚀</div>
        <h4 style="margin: 0; color: #0f172a; font-size: 18px; font-weight: 600;">Atharva Lotankar</h4>
        <p style="font-size: 13px; color: #475569; margin: 0.5rem 0 0 0;">Dashboard & Deployment</p>
    </div>
    """, unsafe_allow_html=True)
...
st.markdown("---")
st.markdown("""
<div style="text-align: center; padding: 2rem 0 1rem 0; color: #94a3b8; font-size: 13px;">
    ...
    <p style="margin: 0.5rem 0 0 0; font-size: 12px;">Built by Het Patel, Ved Zala, Parth Shah & Atharva Lotankar</p>
</div>
""", unsafe_allow_html=True)
